...
namespace Mnk.Library.WpfControls.Dialogs.PerformanceCounters
{
    /// <summary>
    /// Interaction logic for SelectPerfomanceCounters.xaml
    /// </summary>
    public partial class SelectPerformanceCounters
    {
        private ObservableCollection<Entity> knownCounters;
        private ObservableCollection<SelectedEntity> userCounters;
        public static readonly DependencyProperty ItemsSourceProperty =
            DpHelper.Create<SelectPerformanceCounters, ObservableCollection<SelectedEntity>>
